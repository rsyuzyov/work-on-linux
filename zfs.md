...
Рекомендации от всего сердца, выработанные в результате долгих экспериментов и наблюдений в проде: ставьте 128k и не парьтесь. Оно так по-умолчанию и стоит, к слову ;).
